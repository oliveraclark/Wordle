...
class Wordle:
    """Main class, calls itself automaticlly to start the game"""
    def __init__(self):
        """
    ...
    def introduction(self):
        ...
        print(20*"-")
        get_help = input("type 'help' for instuctions on how to play WORDLE: ")
        print(20*"-")        
        if get_help == "help":
            self.instructions() 
        else:        
    ...
    def check_orange(self, word_list):
        ...
        or not and takes gets the letters that are two lettered.
